...
/* Insert value at the beginning of the list. Returns the new first element of the list. */
...
/* HACK: so error would manifest itself (cause a segfault) */
#define free(x) memset(x,0x0,sizeof(*x)); free(x)
